...
if setting == 'The Abandoned Building':
    ...
    response = input(f"It has been awhile since team radioed in...do you stay at the front of the building or do you enter? ")
    if response == "stay":
...
elif setting == "The Distressed Starship":
